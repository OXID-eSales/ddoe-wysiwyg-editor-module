...
if("function"==typeof a().summernote){a(".ddoe-wysiwyg-editor > textarea").each(function(){var b=a(this).attr("data-rte");if("undefined"==typeof b){a(this).attr("data-rte","1"),a(this).closest("td").find(".messagebox").remove();var c=a(this).height(),d=a(this).summernote({lang:"de-DE",minHeight:c||100,toolbar:[["style",["style"]],["formatting",["bold","underline","clear"]],
//[ 'fontname', [ 'fontname' ] ],
["insert",["grid"]],
//[ 'fontsize', [ 'fontsize' ] ],
//[ 'color', [ 'color' ] ],
["layout",["ul","ol","paragraph"]],["height",["height"]],["table",["table"]],["insert",["link","video","hr"]],["misc",["codeview"]]],dialogsInBody:!1,buttons:{ddmedia:"ddmedia"},disableDragAndDrop:!0});"disabled"===a(this).attr("disabled")&&a(this).summernote("disable");var e=d.data("summernote");e.invoke("codeview.activate"),e.invoke("codeview.deactivate")}});var b=a(".ddoe-wysiwyg-editor").first().closest("form");b.find('*[type="submit"]').first().on("click",function(){a(".ddoe-wysiwyg-editor > textarea",b).each(function(){var b=a(this).data("summernote");
