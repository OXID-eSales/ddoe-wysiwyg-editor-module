...
"function"==typeof a().summernote&&a(".ddoe-wysiwyg-editor textarea").each(function(){a(this).closest("td").find(".messagebox").remove();var b=a(this).height();a(this).summernote({lang:"de-DE",minHeight:b||100,toolbar:[["style",["style"]],["formatting",["bold","italic","underline","strikethrough","clear"]],
//[ 'fontname', [ 'fontname' ] ],
["fontsize",["fontsize"]],["color",["color"]],["layout",["ul","ol","paragraph"]],["height",["height"]],["table",["table"]],["insert",["link","video","hr"]],["misc",["codeview"]]],dialogsInBody:!1,buttons:{ddmedia:"ddmedia"},disableDragAndDrop:!0})})})}(jQuery);
