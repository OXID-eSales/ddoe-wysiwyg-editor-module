  ...
  function Editor(context) {
    ...
    this.createLink = this.wrapCommand(function (linkInfo) {
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(anchors, function (idx, anchor) {
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(anchor).attr('href', anchorLink);
...
var LinkDialog_LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    key: "toggleLinkBtn",
    value: function toggleLinkBtn($linkBtn, $linkText, $linkUrl, $linkCms) {
    ...
    value: function showLinkDialog(linkInfo) {
      ...
      return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
        ...
        var $linkCms = _this.$dialog.find('.note-link-cms');
        ...
        _this.ui.onDialogShown(_this.$dialog, function () {
          ...
          $linkText.on('input paste propertychange', function () {
            ...
            _this.toggleLinkBtn($linkBtn, $linkText, $linkUrl, $linkCms);
          }).val(linkInfo.text);
          ...
          $linkCms.on('input paste propertychange', function () {
            _this.toggleLinkBtn($linkBtn, $linkText, $linkUrl, $linkCms);
          }).val(linkInfo.cms);
          ...
          _this.bindEnterKey($linkCms, $linkBtn);
    ...
    value: function show() {
      ...
      var linkInfo = this.context.invoke('editor.getLinkInfo'); //todo: find better way to handle different template engine

      if (/^\[{oxgetseourl/.test(linkInfo.url)) {
